...
export default function UserChatDetailPage() {
  ...
  return (
    <div className="max-w-md mx-auto bg-slate-50 h-screen flex flex-col justify-between shadow-2xl relative overflow-hidden">
      ...
      {/* POPUP CHỌN CHỤP ẢNH / THƯ VIỆN BẢO ĐẢM TÍNH NĂNG TẢI FILE */}
      {showImageMenu && (
      ...
      >
        ...
        <button
          ...
          className="p-2 text-slate-500 hover:text-orange-500 hover:bg-slate-100 rounded-full transition text-lg"
        >
        ...
        <input
          ...
          className="flex-1 bg-slate-100 border-none rounded-xl px-4 py-2 text-xs focus:outline-none focus:ring-2 focus:ring-orange-500"
        />

        <button
          type="submit"
          className="bg-orange-500 hover:bg-orange-600 text-white font-bold text-xs px-4 py-2 rounded-xl shadow-xs transition"
        >
          Gửi
        </button>
      </form>
